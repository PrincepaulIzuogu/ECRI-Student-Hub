...
const SignUpForm = () => {
  ...
  const bachelorCourses = ['Building Products and Processes', 'Energy Systems Engineering', 'Health Informatics', 'Industrial Engineering', 'International Tourism Management / Health and Medical Tourism'];
